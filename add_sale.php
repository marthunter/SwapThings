...
<div class="container">
  <form method="POST" action="add_sale_db.php" enctype="multipart/form-data">
    <div class="row">
      <div class="col-25">
      ...
      <input type="hidden" name="gr_name" value="ซื้อ-ขาย"/>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="price" name="price" maxlength="8" style="width:130px;" required > บาท
      </div>
    </div>
    <div class="row">
      <div class="col-25">
