...
<div class="container">
  <form method="POST" action="add_swap_db.php" enctype="multipart/form-data">
    <div class="row">
      <div class="col-25">
      ...
      <input type="hidden" name="gr_name" value="แลกเปลี่ยน"/>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      <div class="col-25">
        <label for="swapwith">สิ่งของที่ต้องการแลกเปลี่ยนด้วย : </label>
      </div>
      <div class="col-75">
        <input type="text" id="swapwith" name="swapwith" required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
