...
<?php
  $query = "SELECT * FROM thing_list WHERE thingtype = 'ซื้อ-ขาย' ORDER BY thi_li_id DESC" or die("Error: " .
  mysqli_error());
  $result = mysqli_query($conn, $query);
?>
<div>
<h3 id="textaddthing">หมวดหมู่สิ่งของ : ซื้อ-ขาย<a id="addthing" href="add_things.php" ><button class="btn btn-success">+ เพิ่มสิ่งของ</button></a></h3>
<br><br>
