...
if (isset($_POST)) {
    ...
    $sql ="INSERT INTO thing_list(users_name,thingname,thingtype,thingdetail,swapwith,thingimage) VALUES
    ('$users_name','$thingname','$gr_name','$thingdetail','$swapwith','$newname')";
